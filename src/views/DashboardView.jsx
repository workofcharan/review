...
export default function DashboardView() {
  ...
  return (
    <div className="min-h-[calc(100vh-4rem)] max-w-[1600px] mx-auto px-3 sm:px-6 py-4 flex flex-col md:flex-row gap-5 items-start bg-slate-50">
      ...
      {/* Desktop Slide Bar (Collapsible Sidebar matching Image 2) - Frozen / Sticky */}
      <aside 
        className={`hidden md:flex flex-col justify-between shrink-0 sticky top-[5rem] self-start h-[calc(100vh-6rem)] overflow-y-auto rounded-3xl bg-white border border-slate-200/90 shadow-sm p-3 transition-all duration-300 ease-in-out z-20 ${
      ...
      {/* Right Content Area: Top Breadcrumbs + Main Tab Content */}
